...
def {{cookiecutter.pipeline_stage_abbr}}{{cookiecutter.node_name}}({{cookiecutter.raw_data_abbr}}{{cookiecutter.node_name}}: DataFrame) -> DataFrame:
    ...
    Args:
        {{cookiecutter.raw_data_abbr}}{{cookiecutter.pipeline_stage_abbr}}{{cookiecutter.node_name}} (DataFrame): Raw data frame for {{cookiecutter.connector_name}} {{cookiecutter.node_name}}.
